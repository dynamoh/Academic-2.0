...
def academics_module_notif(sender, recipient, type):
    ...
    if type=='registration_approved':
        verb="Your course registration has been verified"
    if type=='registration_declined_fee':
        verb1="Your request for final registration has been declined!"
        verb2=" Please complete Final Reagistration Process again with correct fee details and appropriat ecourse selection"
        verb = verb1+verb2
    if type == "result_announced":
        verb = "Semester results has been announced "
